      ...
      <div className="container mx-auto px-4 max-w-[1200px] mt-10">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-6">
          ...
          <div className="flex-1 min-w-[120px]">
            <h3 className="text-lg font-bold text-[#252B42] text-[16px] mb-2">Company Bio</h3>
        ...
        <div className="mt-16 text-left bg-[#FAFAFA] py-9">
          <p className="text-[#737373] font-bold text-[14px]">Create By Osama Bin Nadeem All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
